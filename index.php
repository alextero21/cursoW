...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Jost:wght@500;700;900&display=swap" rel="stylesheet">
  <link rel="stylesheet" href="css/index.css">
  <script src="https://kit.fontawesome.com/19d575ebcd.js" crossorigin="anonymous"></script>
      ...
      <nav class='menu-navbar'>
        ...
        <div class='header-logo'>
          <a class='logo-link' href='#'>
            <img class='logo-img light-logo' src='' alt='Logo W Designer'>
            <img class='logo-img dark-logo' src='img/logo-light.png' alt='Logo W Designer'>
        ...
        <div class='links menu-wrapper'>
          <ul class='list-js links-list'>
            <li class='menu-item has-sub-menu'>
              <a class='menu-link active' href='#0'>
                Inicio
              </a>
            </li>
            <li class='menu-item has-sub-menu'>
